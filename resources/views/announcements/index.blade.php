                    ...
                    <div class="p-6 lg:p-10">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-1">Kelola data terkait pengumuman pada sistem
                                    beasiswa.</p>
                            </div>
                                        ...
                                        @forelse($data as $key => $item)
                                            <tr class="group hover:bg-blue-50/40 transition-colors duration-200">
                                                ...
                                                <td class="px-6 py-4 text-left text-sm text-slate-500">
                                                    ...
                                                    @else
                                                        <span
                                                            class="inline-flex items-center gap-2 px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider bg-slate-50 text-slate-600 border border-slate-100/50">
                                                            <div
