                    ...
                    <div class="p-6 lg:p-10">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-1">Kelola kriteria yang digunakan dalam perhitungan
                                    metode fuzzy.</p>
                            </div>
                                ...
                                <div class="flex flex-col xl:col-span-6">
                                    ...
                                    <div class="relative group">
                                        <input type="text" id="filter_search" name="search"
                                            value="{{ $filters['search'] ?? '' }}" placeholder="Cari nama kriteria..."
                                        ...
                                        @forelse($data as $key => $item)
                                            <tr class="group hover:bg-blue-50/40 transition-colors duration-200">
                                                ...
                                                <td class="px-6 py-4 text-left">
                                                    <div class="font-bold text-blue-600">{{ $item->criteria_name }}
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <span
                                                        class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-black uppercase tracking-wider
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <div class="relative flex justify-center" x-data="{ open: false, top: 0, left: 0, toggle(el) { this.open = !this.open; if (this.open) { const r = el.getBoundingClientRect();
                                                        ...
                                                        <div x-show="open" @click.outside="open=false"
                                                            ...
                                                            <form
                                                                action="{{ route('fuzzy-criteria.destroy', $item->id) }}"
                                                                method="POST"
                                                                data-confirm-message="Yakin ingin menghapus kriteria ini? Semua keanggotaan terkait juga akan terhapus.">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
                                                ...
                                                <td colspan="5" class="px-6 py-16 text-center">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <h3 class="text-lg font-semibold text-slate-700">Tidak ada
                                                            kriteria ditemukan</h3>
                                                        <p class="text-sm text-slate-500 mt-1">Belum ada kriteria fuzzy
                                                            yang ditambahkan.</p>
                                                        <a href="{{ route('fuzzy-criteria.create') }}"
