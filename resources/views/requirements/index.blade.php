            ...
            <div class="space-y-8">
                <div class="bg-white shadow-xl shadow-slate-200/60 rounded-3xl border border-slate-100">
                    <div class="p-6 lg:p-10">
                        ...
                        {{-- Header --}}
                        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-6">
                            <div>
                        ...
                        <div class="mb-8 rounded-2xl border border-slate-200 bg-slate-50/70 p-4 relative z-10">
                            <form id="filter-form" method="GET" action="{{ route('requirements.index') }}" 
                                                    ...
                                                    <div class="relative flex justify-center"
                                                        ...
                                                        <div x-show="open"
                                                            ...
                                                            <form action="{{ route('requirements.destroy', $item->id) }}" method="POST"
                                                                data-confirm-message="Yakin ingin menghapus persyaratan ini? Tindakan ini tidak dapat dibatalkan.">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
