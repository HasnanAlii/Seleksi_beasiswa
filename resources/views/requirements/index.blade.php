                    ...
                    <div class="p-6 lg:p-10">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-1">Kelola persyaratan yang dibutuhkan untuk
                                        ...
                                        @forelse($data as $key => $item)
                                            <tr class="group hover:bg-blue-50/40 transition-colors duration-200">
                                                ...
                                                <td class="px-6 py-4 text-left">
                                                    <div class="font-bold text-blue-600">{{ $item->requirement_name }}
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <span
                                                        ...
                                                        <div
                                                            class="w-2 h-2 rounded-full {{ $item->scholarshipRequirements->count() > 0 ? 'bg-blue-500' : 'bg-slate-400' }}">
                                                        </div>
                                                ...
                                                <td colspan="4" class="px-6 py-16 text-center">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <h3 class="text-lg font-semibold text-slate-700">Tidak ada
                                                            persyaratan ditemukan</h3>
                                                        <p class="text-sm text-slate-500 mt-1">Belum ada persyaratan
                                                            yang ditambahkan.</p>
                                                        <a href="{{ route('requirements.create') }}"
                                                            class="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800 font-medium hover:underline">+
                                                            Tambah Persyaratan</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
