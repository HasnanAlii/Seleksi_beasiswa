        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <nav class="flex text-sm font-medium text-gray-500">
                ...
                <a href="{{ route('scholarships.index') }}"
                    class="hover:text-blue-600 cursor-pointer transition">Beasiswa</a>
                <span class="mx-2">/</span>
            ...
            <div class="space-y-8">
                ...
                @if (session('success'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3500)"
                        ...
                        <svg class="h-5 w-5 text-emerald-500 shrink-0" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                    ...
                    <div class="p-6 lg:p-10">
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-6">
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-1">Kelola daftar jenis/kategori beasiswa yang
                                    tersedia.</p>
                            </div>
                            ...
                            <div class="overflow-x-auto w-full">
                                <table class="min-w-full divide-y divide-slate-100">
                                    <thead class="bg-slate-50/80">
                                        <tr>
                                            <th
                                                class="px-6 py-4 text-center text-xs font-bold text-slate-500 uppercase tracking-wider w-16">
                                                No</th>
                                            <th
                                            ...
                                            <th
                                                ...
                                                Deskripsi</th>
                                            <th
                                                class="px-6 py-4 text-center text-xs font-bold text-slate-500 uppercase tracking-wider w-24">
                                                Aksi</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <div class="relative flex justify-center" x-data="{ open: false, top: 0, left: 0, toggle(el) { this.open = !this.open; if (this.open) { const r = el.getBoundingClientRect();
                                                        ...
                                                        <div x-show="open" @click.outside="open=false"
                                                            ...
                                                            <form
                                                                action="{{ route('scholarship-types.destroy', $item->id) }}"
                                                                method="POST"
                                                ...
                                                <td colspan="4" class="px-6 py-16 text-center">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <p class="text-sm text-slate-500 max-w-xs mx-auto mt-1">Silakan
                                                            tambahkan jenis beasiswa baru.</p>
                                                        <a href="{{ route('scholarship-types.create') }}"
