                ...
                <div class="bg-white shadow-xl shadow-slate-200/60 rounded-3xl border border-slate-100">
                    <div class="p-6 lg:p-10">
                        ...
                        <div class="mb-8 rounded-2xl border border-slate-200 bg-slate-50/70 p-4 relative z-10">
                            <form id="filter-form" method="GET" action="{{ route('interviews.index') }}"
                                            ...
                                            <tr class="group hover:bg-blue-50/40 transition-colors duration-200">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <div class="text-sm font-bold text-slate-800">
                                                        {{ $item->schedule->translatedFormat('d M Y') }}</div>
                                                    <div class="text-xs text-slate-500">
                                                        {{ $item->schedule->format('H:i') }} WIB</div>
                                                </td>
                                                <td
                                                    class="px-6 py-4 text-left text-sm text-slate-600 max-w-[160px] truncate">
                                                    @if ($item->location)
                                                    ...
                                                    <div class="relative flex justify-center" x-data="{ open: false, top: 0, left: 0, toggle(el) { this.open = !this.open; if (this.open) { const r = el.getBoundingClientRect();
                                                        ...
                                                        <div x-show="open" @click.outside="open=false"
                                                            ...
                                                            @hasrole('admin|staf')
                                                                ...
                                                                <form
                                                                    action="{{ route('interviews.destroy', $item->id) }}"
                                                                    method="POST"
                                                                    data-confirm-message="Yakin ingin menghapus jadwal wawancara ini? Tindakan ini tidak dapat dibatalkan.">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                                ...
                                                <td colspan="7" class="px-6 py-16 text-center">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <p class="text-sm text-slate-500 max-w-xs mx-auto mt-1">Belum
                                                            ada jadwal wawancara yang dibuat.</p>
                                                        <a href="{{ route('interviews.create') }}"
