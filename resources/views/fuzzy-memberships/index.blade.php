                    ...
                    <div class="p-6 lg:p-10">
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-6">
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-1">Kelola nilai min, mid, dan max setiap label kriteria fuzzy.</p>
                            </div>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <div class="relative flex justify-center"
                                                        ...
                                                        <div x-show="open"
                                                            ...
                                                            <form action="{{ route('fuzzy-memberships.destroy', $item->id) }}" method="POST"
                                            ...
                                            <tr>
                                                <td colspan="7" class="px-6 py-16 text-center">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <h3 class="text-lg font-semibold text-slate-700">Tidak ada keanggotaan ditemukan</h3>
                                                        <p class="text-sm text-slate-500 mt-1">Belum ada fungsi keanggotaan yang ditambahkan.</p>
                                                        <a href="{{ route('fuzzy-memberships.create') }}" class="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800 font-medium hover:underline">+ Tambah Keanggotaan</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
