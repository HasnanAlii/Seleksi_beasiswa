                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="text-base font-bold text-slate-800">
                                    {{ $assessment->interview->schedule->format('H:i') }} - {{ $assessment->interview->schedule->copy()->addMinutes(30)->format('H:i') }} WIB
                                </div>
                            </div>
                            <div class="md:col-span-2">
                                <div class="text-xs font-semibold text-slate-400 mb-1">Lokasi Wawancara</div>
                                <div class="text-base font-bold text-slate-800">{{ $assessment->interview->location ?? '-' }}</div>
                            </div>
                        </div>
                    </div>
